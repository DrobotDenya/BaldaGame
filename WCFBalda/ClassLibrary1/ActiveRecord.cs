...
namespace WCFBalda
{
    ...
    {
        //byte[] filedata = File.ReadAllBytes("../../Resources/User.accdb");
        private const string ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=http://localhost:13394/Resources/User.accdb";
        ...
        {
            FileStream fs = File.Open(ConnectionString, FileMode.Open, FileAccess.Write, FileShare.None);
